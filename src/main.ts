...
function renderRunbooks(): void {
  ...
  workspace.innerHTML = `
    <section class="catalog" aria-labelledby="app-title">
      <div class="catalog-heading"><div><p class="eyebrow">Specimen drawer</p><h1 id="app-title">Runbooks</h1></div><button class="button small" data-action="add">+ Add folder</button></div>
